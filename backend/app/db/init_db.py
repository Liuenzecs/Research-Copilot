...
POST_BASELINE_INDEXES = {
    ...
    'ix_paper_research_state_read_at',
    'ix_papers_merged_into_paper_id',
    'ix_papers_pdf_status',
    'ix_papers_integrity_status',
    'ix_research_project_saved_searches_search_mode',
    'ix_research_project_saved_search_candidates_selected_by_ai',
    'ix_research_project_saved_search_candidates_selection_bucket',
...
POST_BASELINE_COLUMNS = {
    ...
    ('paper_research_state', 'read_at'),
    ('weekly_reports', 'project_id'),
    ('research_project_saved_searches', 'search_mode'),
    ('research_project_saved_searches', 'user_need'),
    ('research_project_saved_searches', 'selection_profile'),
    ('research_project_saved_searches', 'target_count'),
    ('research_project_saved_search_candidates', 'selected_by_ai'),
    ('research_project_saved_search_candidates', 'selection_bucket'),
    ('research_project_saved_search_candidates', 'selection_rank'),
}
