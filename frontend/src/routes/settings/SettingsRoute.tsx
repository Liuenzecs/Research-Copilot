  ...
  return (
    <>
      <Card>
        ...
        <p className="subtle">
          查看模型提供方、本地运行路径和桌面版运行状态。桌面版默认把数据写入用户目录，不再回写仓库里的开发数据库。
        </p>
      </Card>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <div className="reader-meta-card" data-testid="desktop-build-card">
              ...
              <div className="subtle" style={{ marginTop: 8 }}>
                这张卡用来确认你现在运行的到底是不是最新桌面包。日常增量打包用 `npm run desktop:build`；只有出现“像旧包”“时间不对”“MSI 被占用”或 sidecar 异常时，再用
            ...
            <div className="reader-meta-card">
              ...
              <div className="subtle">Semantic Scholar API Key：{settings.semantic_scholar_api_key_configured ? "已配置" : "未配置"}</div>
            ...
            <div className="reader-meta-card" data-testid="test-db-note">
              ...
              <div className="subtle">`frontend/src-tauri/target` 是桌面构建缓存主目录，日常不用手动删；只有异常时再用 fresh build。</div>
            </div>
